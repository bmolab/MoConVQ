...
class ODESim:
    class BVHToTarget:
        class BVHToTargetBase:
            def __init__(self, bvh_data: Union[str,pymotionlib.MotionData.MotionData], bvh_fps: int, character, ignore_root_xz_pos: bool = ..., bvh_start: Optional[int] = ..., bvh_end: Optional[int] = ..., set_init_state_as_offset: bool = ..., smooth_type: Union[Common.SmoothOperator.GaussianBase,Common.SmoothOperator.ButterWorthBase,None] = ..., flip = ..., motion_fps = ...) -> Any: ...
...
class pymotionlib:
    class BVHLoader:
        ...
        def load_amass_npz(self, unicodebvh_str: str, smpl_str: str, insert_T_pose: bool = ..., ignore_root_offset = ..., max_frames = ..., ignore_root_xz_pos = ...) -> Any: ...
